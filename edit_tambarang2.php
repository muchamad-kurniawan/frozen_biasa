       ...
       <?php include("header.php"); ?>
        ...
        <div class="container-fluid" id="main-container">
            ...
            <div id="main-content">
               ...
               <form action="proses.php?aksi=update2" method="post" class="form-horizontal">
                
                    <?php 
                    foreach ($db->edit3($_GET['nama']) as $d) 
                    {
                        ?>
                    ...
                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" placeholder="xlarge" class="input-xlarge" name="nama" value="<?php echo $d['nama']?>" disabled/>
                                       </div>
                                    </div>
                    ...
                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" placeholder="xlarge" class="input-xlarge" name="jumlah" value="<?php echo $d['jumlah']?>" />
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" placeholder="xlarge" class="input-xlarge" name="jumlah" value="<?php echo $d['hargabeli']?>" />
                                        <!--   <span class="help-inline">Some hint here</span> -->
                                       </div>
                                    </div>
                     <div class="control-group">
                                    <!--  <label class="control-label">Jumlah</label> -->
                                       <div class="controls">
                                          <input type="text" placeholder="xlarge" class="input-xlarge" value="<?php echo $d['jumlah']?>" style="visibility: hidden;" name="jumlahlama"/>
                                        <!--   <span class="help-inline">Some hint here</span> -->
                                       </div>
                                    </div>
