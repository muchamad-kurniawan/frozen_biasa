...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
       ...
       <?php include("header.php"); ?>
        ...
        if(isset($_POST['test']))
        { ?>
            <div class="alert alert-error" style="margin-left:30%; margin-right:30%;">
    <button type="button" class="close" data-dismiss="alert">&times;</button>
    <h4>Maaf.!!</h4>
    Username dan Password yang Anda Inputkan Salah...!! ^_^...    </div>
        <?php
        } 
            ...
            <div id="main-content">
                ...
                <div id="breadcrumbs">
                    ...
                    ?>
                 <form action="tambarang.php" method="post">
...
<br>
                    ...
                    <div class="controls">
                        ...
                        <input type="text" class="input-xlarge" placeholder="Only numbers" name="Jumlah" id="numberfield" data-rule-number="true" data-rule-required="true" value="1">
                        <button class="btn btn-primary btn-xlarge" type="submit" value="Simpan" name="test"><i class="icon-expand"></i> Tambah</button>
                     </div>
                    </div>
                    <div class="controls">
