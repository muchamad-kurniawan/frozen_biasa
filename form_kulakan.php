               ...
               <div class="row-fluid">
                    <div class="span3">
                        <div class="box box-black">
                                ...
                                <a href="tambah_barang_kulakan.php"><button class="btn-block btn btn-large btn-primary">Tambah Barang </button></a>
                           <br>
                            </div>
                        </div>
                </div>
                ...
                <div class="row-fluid">
                      <form action="tamjual3.php" method="post" class="form-horizontal">
                                    ...
                                    <tr class="table-flag-blue">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                               ...
                                               <a class="btn btn-small show-tooltip" title="Edit" href="edit_tambarang2.php?nama=<?php echo $data['nama'];?>&aksi=edit3" role="button" data-toggle="modal"><i class="icon-edit"></i></a>
